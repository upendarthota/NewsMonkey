...
const News = (props) => {
  ...
  const updateNews = async () => {
    ...
    const url=`https://newsapi.org/v2/everything?q=${props.category}&from=2025-02-02&to=2025-02-02&sortBy=popularity&apiKey=${props.apiKey}&page=${page}&pageSize=${props.pageSize} `
  //  // setLoading(true);
